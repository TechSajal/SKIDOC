...
class NameDiseaseSettingAdapter(val context: Context, val data:ArrayList<getadvice>): RecyclerView.Adapter<NameDiseaseSettingAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NameDiseaseSettingAdapter.MyViewHolder, position: Int) {
